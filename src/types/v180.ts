 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type StableswapCall = StableswapCall_create_pool | StableswapCall_update_pool_fee | StableswapCall_update_amplification | StableswapCall_add_liquidity | StableswapCall_add_liquidity_shares | StableswapCall_remove_liquidity_one_asset | StableswapCall_withdraw_asset_amount | StableswapCall_sell | StableswapCall_buy | StableswapCall_set_asset_tradable_state
 ...
 */
export type StableswapEvent = StableswapEvent_PoolCreated | StableswapEvent_FeeUpdated | StableswapEvent_LiquidityAdded | StableswapEvent_LiquidityRemoved | StableswapEvent_SellExecuted | StableswapEvent_BuyExecuted | StableswapEvent_TradableStateUpdated | StableswapEvent_AmplificationChanging
