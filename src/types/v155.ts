...
export type Type_316 = Type_316_V2 | Type_316_V3
...
export type Type_323 = Type_323_WithdrawAsset | Type_323_ReserveAssetDeposited | Type_323_ReceiveTeleportedAsset | Type_323_QueryResponse | Type_323_TransferAsset | Type_323_TransferReserveAsset | Type_323_Transact | Type_323_HrmpNewChannelOpenRequest | Type_323_HrmpChannelAccepted | Type_323_HrmpChannelClosing | Type_323_ClearOrigin | Type_323_DescendOrigin | Type_323_ReportError | Type_323_DepositAsset | Type_323_DepositReserveAsset | Type_323_ExchangeAsset | Type_323_InitiateReserveWithdraw | Type_323_InitiateTeleport | Type_323_ReportHolding | Type_323_BuyExecution | Type_323_RefundSurplus | Type_323_SetErrorHandler | Type_323_SetAppendix | Type_323_ClearError | Type_323_ClaimAsset | Type_323_Trap | Type_323_SubscribeVersion | Type_323_UnsubscribeVersion | Type_323_BurnAsset | Type_323_ExpectAsset | Type_323_ExpectOrigin | Type_323_ExpectError | Type_323_ExpectTransactStatus | Type_323_QueryPallet | Type_323_ExpectPallet | Type_323_ReportTransactStatus | Type_323_ClearTransactStatus | Type_323_UniversalOrigin | Type_323_ExportMessage | Type_323_LockAsset | Type_323_UnlockAsset | Type_323_NoteUnlockable | Type_323_RequestUnlock | Type_323_SetFeesMode | Type_323_SetTopic | Type_323_ClearTopic | Type_323_AliasOrigin | Type_323_UnpaidExecution
...
export interface Type_323_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}
...
export interface Type_323_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}

export interface Type_323_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_323_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value: (V3MultiLocation | undefined)
}

export interface Type_323_ExpectError {
    __kind: 'ExpectError'
    value: ([number, V3Error] | undefined)
}

export interface Type_323_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_323_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Uint8Array
    responseInfo: V3QueryResponseInfo
}

export interface Type_323_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Uint8Array
    moduleName: Uint8Array
...
export interface Type_323_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_323_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_323_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_323_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_323_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_323_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_323_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_323_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}

export interface Type_323_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_323_SetTopic {
    __kind: 'SetTopic'
    value: Uint8Array
}

export interface Type_323_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_323_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_323_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin: (V3MultiLocation | undefined)
}
