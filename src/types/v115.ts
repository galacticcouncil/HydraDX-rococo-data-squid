...
export type Event = Event_System | Event_Scheduler | Event_Balances | Event_TransactionPayment | Event_Treasury | Event_Utility | Event_Preimage | Event_Identity | Event_Democracy | Event_Elections | Event_Council | Event_TechnicalCommittee | Event_Tips | Event_Proxy | Event_Multisig | Event_Uniques | Event_AssetRegistry | Event_Claims | Event_CollatorRewards | Event_Omnipool | Event_TransactionPause | Event_Tokens | Event_Currencies | Event_Vesting | Event_ParachainSystem | Event_PolkadotXcm | Event_CumulusXcm | Event_XcmpQueue | Event_DmpQueue | Event_OrmlXcm | Event_XTokens | Event_UnknownTokens | Event_CollatorSelection | Event_Session | Event_RelayChainInfo | Event_MultiTransactionPayment
 ...
 */
export type OmnipoolEvent = OmnipoolEvent_TokenAdded | OmnipoolEvent_LiquidityAdded | OmnipoolEvent_LiquidityRemoved | OmnipoolEvent_SellExecuted | OmnipoolEvent_BuyExecuted | OmnipoolEvent_PositionCreated | OmnipoolEvent_PositionDestroyed | OmnipoolEvent_PositionUpdated | OmnipoolEvent_TradableStateUpdated | OmnipoolEvent_AssetRefunded | OmnipoolEvent_AssetWeightCapUpdated
